    ...
    <div class="row align-items-center justify-content-lg-between">
        <div class="col-xl-6">
            <div class="copyright text-center text-lg-left text-muted">
                &copy; {{ now()->year }} <a href="{{ route('admin/dashboard') }}" class="font-weight-bold ml-1">Booker</a> 
            </div>
        </div>
        <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                ...
                <li class="nav-item"><a href="{{ route('admin.contactmessages') }}" class="nav-link">Contact Messages</a></li>
            </ul>
        </div>
    </div>
</footer>
