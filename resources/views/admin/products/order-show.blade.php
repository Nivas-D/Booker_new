                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.product.orders') }}">Orders</a></li>
                                <li class="breadcrumb-item active" aria-current="page">View</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('admin.product.orders') }}" class="btn btn-sm btn-neutral">Back To Orders</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="row mt-4 mb-5">
                            ...
                            <div class="col-md-10">
                                <div class="table-responsive py-4" id="orders-table">
