                                ...
                                <div class="table-responsive py-4" id="services-table">
                                    <table class="table align-items-center table-flush" id="datatable-basic">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-primary">Service Description German</td>
                                                <td class="text-primary">{!! ucfirst($service->description_german) !!}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-primary">Service Description France</td>
                                                <td class="text-primary">{!! ucfirst($service->description_france) !!}</td>
                                            </tr>
                                            <tr>
