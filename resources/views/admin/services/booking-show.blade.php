                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.service.bookings') }}">Bookings</a></li>
                                <li class="breadcrumb-item active" aria-current="page">View</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('admin.service.bookings') }}" class="btn btn-sm btn-neutral">Back To Bookings</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-primary">
                                                    <img src="{{ asset($booking->service_image) }}" height="100" width="100" alt="Service Image" class="img-fluid">    
                                                </td>
                                            </tr>
                                            <tr>
