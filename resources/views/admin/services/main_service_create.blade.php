                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="row mt-5 mb-5">
                            ...
                            <div class="col-md-8">
                                <form role="form" method="POST" id = "service_form" action="{{ route('main-services.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label" for="industry">Category</label>
