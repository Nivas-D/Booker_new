                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h2 font-weight-bold mb-0 text-white">{{ $stats['userCount'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-gradient-default border-0">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Freelancers</h5>
                                <span class="h2 font-weight-bold mb-0 text-white">{{ $stats['freelancerCount'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('products.index') }}" class="btn btn-sm btn-primary">See all</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('services.index') }}" class="btn btn-sm btn-primary">See all</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
