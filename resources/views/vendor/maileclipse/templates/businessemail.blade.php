...
<div class="content"><span class="brand"> <a href="#"> Booker</a></span></div>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td class="soapbox-title">Welcome to Booker!</td>
</tr>
</tbody>
</table>
...
<div class="body-title">Dear @if($mailData) <span>{{ $mailData['name'] }}</span> @endif, thanks for register</div>
<table class="body-text">
<tbody>
<tr>
<td class="body-text-cell">Thank you for registering your business with us. An admin will review your registration, and if necessary, they will contact you for further details. If you have any questions, please feel free to contact our support team.</td>
</tr>
</tbody>
</table>
...
<p>Thanks so much,</p>
<p class="body-signature">Booker Admin</p>
</td>
</tr>
</tbody>
</table>
