                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="row mt-5 mb-5">
                            ...
                            <div class="col-md-8">
                                <form role="form" method="POST" action="{{ route('owner.products.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group{{ $errors->has('price_original') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-name">{{ __('Price Original') }}</label>
                                    ...
                                    <div class="form-group{{ $errors->has('quantity') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-name">{{ __('Available Quantity (CHF)') }}</label>
