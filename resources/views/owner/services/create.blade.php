                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('owner.products.index') }}">Services</a></li>
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="row mt-5 mb-5">
                            ...
                            <div class="col-md-8">
                                <form role="form" method="POST" action="{{ route('owner.services.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group{{ $errors->has('duration') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-name">{{ __('Duration') }}</label>
