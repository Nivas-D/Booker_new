                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="row mt-5 mb-5">
                            ...
                            <div class="col-md-8">
                                <form method="post"  action="{{ route('owner.services.update', $service) }}" enctype="multipart/form-data" role="form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="text-center" id="editService">
                                        <button type="submit" class="btn btn-primary btn-block my-5">{{ __('Edit Service') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
