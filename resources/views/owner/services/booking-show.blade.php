@extends('layouts.owner-app', [
    ...
    'elementName' => 'service-bookings-show'
])
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 d-inline-block mb-0">View Booking</h6>
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fas fa-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="{{ route('owner/dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('owner.service.bookings') }}">Bookings</a></li>
                                <li class="breadcrumb-item active" aria-current="page">View</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('owner.service.bookings') }}" class="btn btn-sm btn-neutral">Back To Bookings</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table align-items-center table-flush"  id="datatable-basic">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-primary">{{ $booking->user_name }}</td>
                                            </tr> 
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="text-primary">Service Image</td>
                                                <td class="text-primary"><img src="{{ asset($booking->service_image) }}" height="100" width="100" alt="Service Image" class="img-fluid" /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="text-primary">Booking Status</td>
                                                <td class="text-primary">{{ ucwords($booking->booking_status) }}</td>
                                            </tr> 
                                            <tr>
                                                <td class="text-primary">Payment Method</td>
                                                <td class="text-primary">{{ ucwords($booking->payment_method) }}</td>
                                            </tr> 
                                            <tr>
                                                <td class="text-primary">Payment Status</td>
                                                <td class="text-primary">{{ ucwords($booking->payment_status) }}</td>
                                            </tr> 
                                            <tr>
                                                <td class="text-primary">Created At</td>
                                                <td class="text-primary">{{ $booking->created_at }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
