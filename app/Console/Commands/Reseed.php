...
class Reseed extends Command
{
    ...
    public function handle()
    {
        ...
        File::copy(storage_path('profile_pictures/team-3.jpg'), public_path('admin/img/theme/team-3.jpg'));
        File::copy(storage_path('profile_pictures/team-4.jpg'), public_path('admin/img/theme/team-4.jpg'));
        File::copy(storage_path('profile_pictures/team-5.jpg'), public_path('admin/img/theme/team-5.jpg'));
    }
}
